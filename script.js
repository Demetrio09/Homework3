...
alert("Welcome to our Passworld Generator!");
...
// Setup variables;
    ...
    var randomLetter12 = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
...
// If and Else if statments collecting data from user;
    ...
    if (specialCharacter === true || specialCharacter === false) {
        ...
        alert("Your new passworld is: " + randomLetter12);
    }
